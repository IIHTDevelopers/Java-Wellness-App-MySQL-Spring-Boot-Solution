...
public class WellnessPlanController {
	...
	public ResponseEntity<List<WellnessPlanDTO>> getAllWellnessPlansByUserId(@PathVariable Long userId) {
		List<WellnessPlanDTO> plans = wellnessPlanService.getAllWellnessPlansByUserId(userId);
